...
var plugin = require('@stylistic/eslint-plugin');
var plugin$1 = require('@typescript-eslint/eslint-plugin');
var parser = require('@typescript-eslint/parser');
var plugin$2 = require('eslint-plugin-vue');
var parser$1 = require('vue-eslint-parser');
...
function vue(options) {
    ...
    return [{
            ...
            languageOptions: {
                parser: parser$1,
                parserOptions: {
                    parser: options.typescript ? parser__namespace : null,
